...
public class UserReportingScript : MonoBehaviour
{
    ...
    public UnityEvent UserReportSubmitted;
    ...
    public void CreateUserReport()
    {
        ...
        UnityUserReporting.CurrentClient.CreateUserReport((br) =>
        {
            ...
            // Attachments
            //br.Attachments.Add(new UserReportAttachment("Log.json", "Log.json", "application/json", System.Text.Encoding.UTF8.GetBytes(PhilResearch.ReportingLog.current.ReportData)));
    ...
    public void SubmitUserReport()
    {
        ...
        // Set Summary
        this.CurrentUserReport.Summary = PhilResearch.ReportingLog.current.SessionId + ":" + PhilResearch.ReportingLog.current.testName;

        this.CurrentUserReport.Attachments.Add(new UserReportAttachment("Log.json", "Log.json", "application/json", System.Text.Encoding.UTF8.GetBytes(PhilResearch.ReportingLog.current.ReportData)));

        // Set Category
        this.CurrentUserReport.Dimensions.Add(new UserReportNamedValue("Category", PhilResearch.ReportingLog.current.testName));
        this.CurrentUserReport.Fields.Add(new UserReportNamedValue("Category", PhilResearch.ReportingLog.current.testName));

        // Set Description
        UserReportNamedValue userReportField = new UserReportNamedValue();
        userReportField.Name = "Description";
        userReportField.Value = "Results for session: " + PhilResearch.ReportingLog.current.SessionId + ", Test: " + PhilResearch.ReportingLog.current.testName;
